    ...
    return(
        <form onSubmit={onSubmitForm}>
            ...
            <div className="form-group col col-lg-4 mb-3">
                ...
                <input type="text" name="precio" className="form-control" id="grade" value={estadoForm.price} onChange={gestionarCamposForm}/>
            </div>
            <div className="form-group col col-lg-4 mb-3">
                <label htmlfor="img">img</label>
                <input type="text" name="precio" className="form-control" id="grade" value={estadoForm.img} onChange={gestionarCamposForm}/>
            </div>
            <div className="mb-3">
